...
export default function Cart() {
  ...
  const { cartProducts, totalPrice, updateQuantity, removeFromCartByProductId } = useContextElement();
  ...
  const removeItem = (id) => removeFromCartByProductId(id);
                    ...
                    <tr key={i} className="tf-cart-item file-delete">
                      <td className="tf-cart-item_product">
                        <Link href={`/product-detail/${elm.id}`} className="img-box">
                          <Image alt="img-product" src={elm.imgSrc} width={668} height={932} />
                        </Link>
                        <div className="cart-info">
                          ...
                          <span className="remove-cart link remove" onClick={() => removeItem(elm.id)}>
                            Remove
                          </span>
                        </div>
                      </td>
                      <td className="tf-cart-item_price" cart-data-title="Price">
                        <div className="cart-price">${elm.price.toFixed(2)}</div>
                      </td>
            ...
            <div className="tf-cart-footer-inner">
              ...
              <div className="tf-page-cart-checkout">
                ...
                <div className="tf-cart-totals-discounts">
                  <h3>Subtotal</h3>
                  <span className="total-value">${totalPrice.toFixed(2)} USD</span>
                </div>
                <p className="tf-cart-tax">
                  Taxes and
                  <Link href={`/shipping-delivery`}>shipping</Link> calculated at checkout
                </p>
                <div className="cart-checkbox">
