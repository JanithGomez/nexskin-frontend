        ...
        <div className="modal-content">
          ...
          <div className="wrap">
            ...
            <div className="tf-mini-cart-wrap">
                    ...
                    {cartProducts.map((elm, i) => (
                      <div key={i} className="tf-mini-cart-item">
                        ...
                        <div className="tf-mini-cart-info">
                          <Link className="title link" href={`/product-detail/${elm.id}`}>
                            {elm.title}
                          </Link>
                          <div className="meta-variant">Light gray</div>
                          <div className="price fw-6">${elm.price?.toFixed(2)}</div>
                        ...
                        <SwiperSlide key={i} className="swiper-slide">
                          <div className="tf-minicart-recommendations-item">
                            ...
                            <div className="tf-minicart-recommendations-item-infos flex-grow-1">
                              ...
                              <div className="price">${elm.price.toFixed(2)}</div>
                            </div>
              ...
              <div className="tf-mini-cart-bottom">
                ...
                <div className="tf-mini-cart-bottom-wrap">
                  <div className="tf-cart-totals-discounts">
                    ...
                    <div className="tf-totals-total-value fw-6">${totalPrice.toFixed(2)} USD</div>
                  </div>
                  ...
                  <div className="tf-mini-cart-view-checkout">
                    <Link href={`/view-cart`} className="tf-btn btn-outline radius-3 link w-100 justify-content-center">
                      View cart
                    </Link>
                    <Link
                      href={`/checkout`}
              ...
              <div className="tf-mini-cart-tool-openable add-note" ref={addNoteRef}>
                <div
              ...
              <div className="tf-mini-cart-tool-openable add-gift" ref={addGiftRef}>
                <div
                  className="overplay tf-mini-cart-tool-close"
                  onClick={() => addGiftRef.current.classList.remove('open')}
                />
                <form onSubmit={(e) => e.preventDefault()} className="tf-product-form-addgift">
                  <div className="tf-mini-cart-tool-content">
              ...
              <div className="tf-mini-cart-tool-openable estimate-shipping" ref={addShipingRef}>
                <div
                  className="overplay tf-mini-cart-tool-close"
