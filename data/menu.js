export const WomensProductPages = [
  {
    heading: "Face Care",
    links: [
...
export const MensProductsPages = [
  {
    heading: "Men Skin Care",
    links: [
...
export const brandProductsPages = [
  {
    heading: "The Ordinery",
    links: [
      { href: "/product-detail/1", text: "Skin Care" },
      { href: "/product-grid-1/2", text: "Hair Care" },
      { href: "/product-grid-2/3", text: "Body" },
    ],
  },
  {
    heading: "Cetiple",
    links: [
      { href: "/product-inner-zoom/12", text: "Skin Care" },
      { href: "/product-zoom-magnifier/13", text: "Hair Care" },
      { href: "/product-no-zoom/14", text: "Body" },
    ],
  },
  {
    heading: "Loreal",
    links: [
      { href: "/product-color-swatch/22", text: "Skin Care" },
      { href: "/product-rectangle/23", text: "Hair Care" },
      { href: "/product-rectangle-color/24", text: "Body" },
    ],
  }
];
